...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Initializing Views
        editTextUsersurname = (EditText) findViewById(R.id.editTextsurname);
            ...
            public void onClick(View v) {
                ...
                StringRequest stringRequest = new StringRequest(Request.Method.POST, Config.CONFIRM_URL,
                    ...
                    protected Map<String, String> getParams() throws AuthFailureError {
                        ...
                        params.put(Config.KEY_USERNAME, usersurname);
                        return params;
                    }
                };
    ...
    private void register() {
        ...
        //Getting user data
        usersurname = editTextUsersurname.getText().toString().trim();
        password= editTextPassword.getText().toString().trim();
        phone = editTextPhone.getText().toString().trim();
        name = editTextname.getText().toString().trim();
        user_idx =  editTextUserID.getText().toString().trim();
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, Config.REGISTER_URL,
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                params.put(Config.KEY_USEID , user_idx);
                params.put(Config.KEY_NAME, name);
                params.put(Config.KEY_NAME, phone);
                return params;
            }
        };
